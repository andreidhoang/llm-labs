...
from basics.flash_attention import flash_attention
...
class CausalMultiHeadSelfAttention(nn.Module):
    ...
    def forward(
        ...
        *batch_dims, sequence_length, d_model = x.size()
        ...
        # Causality is enforced inside the FA kernel (triton path) or via
        # is_causal=True in the SDPA fallback — no explicit mask materialized.
