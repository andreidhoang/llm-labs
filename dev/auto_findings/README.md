...
autoresearch sessions on `llm-labs/core/`. Three Vast.ai 1×H200 overnight
sessions, 22 experiments, $13.22 total compute.
...
**Five findings surfaced for Tier 2 preregistration** (see [lessons.md](lessons.md)).
...
Per-session plots: [`plots/2026-05-17.png`](plots/2026-05-17.png), [`plots/2026-05-18.png`](plots/2026-05-18.png), [`plots/2026-05-19.png`](plots/2026-05-19.png).
...
| **Total** | — | **205 min** | **22** | **$13.22** | **1.0575** |

For comparison: one Tier 2 cell (8×H100 × 2hr × $16/hr) = **$32**. Total Tier 1
spend = **41% of a single Tier 2 cell**, produced 5 promotion candidates that
